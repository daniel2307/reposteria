...
@section('content')
<form action="{{ url('reporte/pedido') }}" method="get">
    <div class="form-row mt-1">
        ...
        <div class="col-2">
            <select class="mdb-select md-form colorful-select dropdown-primary" name="tipo">
                <option value="tienda" {{ $tipo == "tienda" ? 'selected' : '' }}>Tienda</option>
                <option value="movil" {{ $tipo == "movil" ? 'selected' : '' }}>App movil</option>
            </select>
            <label>Tipo:</label>
        </div>
        <div class="col-2">
            <select class="mdb-select md-form colorful-select dropdown-primary" name="estado">
                <option value="espera" {{ $estado == "espera" ? 'selected' : '' }}>En espera</option>
...
<hr>
<h3>Detalle Pedidos en tienda del mes</h3>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#cmi-reporte-pedido').addClass('current-menu-item');
